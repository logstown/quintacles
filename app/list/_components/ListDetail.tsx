        ...
        {listItemsReverse.map((item, i) => (
          ...
          >
            ...
            <div className='relative flex w-full items-center lg:w-3/5'>
              <p className='absolute z-30 bg-gradient-to-r from-white to-transparent bg-clip-text text-[200px] text-transparent drop-shadow-2xl sm:text-[400px] xl:text-[550px]'>
                {5 - i}
              </p>
              <NextImage
                unoptimized
