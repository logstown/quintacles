...
import { fancy } from '@/config/fonts'
    ...
    <div>
      ...
      <div className='mx-auto mt-8 flex max-w-screen-lg flex-col items-center gap-12 sm:mt-16 lg:gap-20'>
        {listItemsReverse.map((item, i) => (
          <div
            key={item.tmdbId}
            className='flex aspect-video w-full items-end justify-center rounded-xl bg-cover bg-center px-6 pb-6 pt-52 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] sm:px-16 sm:pb-16'
            style={{
              backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 1)),url(${item.backdropUrl})`,
            }}
          >
            <div className='flex flex-col items-center justify-around sm:flex-row sm:items-baseline'>
              <h2 className='z-30 text-7xl text-neutral-200 drop-shadow-2xl'>
                {5 - i}
              </h2>
              <div className='flex max-w-prose flex-col gap-10'>
                <div
                  className={`flex justify-center gap-6 sm:gap-10 lg:gap-12 ${isEpisodes ? 'items-start' : `${item.logoPath ? 'items-center' : 'items-end'}`}`}
                >
                  {/* <h2
